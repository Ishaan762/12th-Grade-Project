	...
	def admin_details():
	    try:
	        ...
	        while True:
	            ...
	            flag=1
	            for cj in sname:
	                if cj.isalnum()==True or cj.isspace()==True:
	                    continue
	                else:
	                    flag=0
	            if flag==1:
	        ...
	        while True:
	            ...
	            hjk=str(phon)
	            if phon.isdigit()==True and len(hjk)==10:
	                break
	            else:
	                print("Please enter a valid value")
	        while True:
	...
	def search_admin_details():
	    mycon=co.connect(host="localhost", user="root", passwd="1234", database="Project")  
	    cursor=mycon.cursor()
	    ac=int(input("Enter admission numb"))
	    try:
	...
	def edit_name():
	    ...
	    while True:
	        ...
	        if flag==1:
	            ...
	            print("Please enter a valid value")
	    st= "update admission set Name='%s' where Admission_Number=%s"%(nm,ac) 
	    cursor.execute(st)
	    mycon.commit()
	...
	def edit_address():
	    ...
	    while True:
	        ...
	        if flag==1:
	            ...
	            print("Please enter a valid value")
	    st= "update admission set Address='%s' where Admission_Number=%s"%(nm,ac) 
	    cursor.execute(st)
	    mycon.commit()
	    print ('Data updated successfully')
	    cm=input("press any key to continue\n")
	...
	def edit_phno():
	    ...
	    while True:
	        ...
	        hmn=str(nm)
	        if len(hmn)==10 and hmn.isdigit():
	            break
	        else:
	            print("Please enter a valid value")
	    st= "update admission set Phone_no='%s' where Admission_Number=%s"%(nm,ac) 
	    cursor.execute(st)
	    print("Success") 
	    cm=input("press any key to continue\n")
	    print(cm)
